...
<body>
    ...
    <div class="container">
        ...
        <form action="signin_db.php" method="post">
            ...
            <button type="submit" name="signin" class="btn btn-primary">ເຂົ້າສູ່ລະບົບ</button>
        </form>
        <hr>
        <p>ຍັງບໍ່ໄດ້ເປັນສະມາຊິກແມ່ນບໍ່ ກົດບ່ອນນີ້ເພື່ອ <a class="fw-bold" href="index.php">ສະມັກສະມາຊິກ</a></p>
    </div>
